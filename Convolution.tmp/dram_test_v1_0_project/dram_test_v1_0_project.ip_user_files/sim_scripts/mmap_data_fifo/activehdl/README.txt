...
#
# Generated by export_simulation on Tue Nov 28 19:14:33 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './mmap_data_fifo.sh' script.

./mmap_data_fifo.sh -reset_run
...
./mmap_data_fifo.sh -noclean_files

For more information on the script, please type './mmap_data_fifo.sh -help'.
