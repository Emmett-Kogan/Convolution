...
#
# Generated by export_simulation on Thu Dec 07 22:35:03 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './dma_fifo.sh' script.

./dma_fifo.sh -reset_run
...
./dma_fifo.sh -noclean_files

For more information on the script, please type './dma_fifo.sh -help'.
