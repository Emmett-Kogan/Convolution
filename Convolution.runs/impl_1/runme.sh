...
HD_PWD='C:/Users/johnn/Documents/School/reconfig/Convolution/Convolution.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log baseDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source baseDesign_wrapper.tcl -notrace
