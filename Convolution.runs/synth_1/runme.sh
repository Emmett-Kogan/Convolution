...
HD_PWD='C:/Users/johnn/Documents/School/reconfig/Convolution/Convolution.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log baseDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source baseDesign_wrapper.tcl
