...
HD_PWD='C:/Users/johnn/Documents/School/reconfig/Convolution/Convolution.runs/baseDesign_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log baseDesign_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source baseDesign_clk_wiz_0_0.tcl
